      ...
      <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className="border-[--color-neutral-200] focus-visible:ring-[--color-primary-600] bg-white text-[--color-neutral-800] cursor-pointer rounded-none file:mr-4 file:py-2 file:px-4 file:border-0 file:text-sm file:font-semibold file:bg-[--color-primary-600] file:text-white hover:file:bg-[--color-primary-700]"
          />
        </div>
      </CardContent>
    </Card>
